...
% Referanser
\begin{frame}[fragile]{Referanser}
Kan legge kommandoen \texttt{label} på følgende miljøer.
\begin{itemize}
\item
\texttt{section}
\item
...
$\cdots$
\end{itemize}
Refererer ved å bruke kommandoen \texttt{ref}.
\end{frame}

\begin{frame}[fragile]{Referanser, eksempel}
...
Nå kan vi snakke om ligning \ref{eq:costfunction} i teksten vår opptil flere ganger, uavhengig av hvor mange andre ligninger som måte komme til.

\begin{Verbatim}[fontsize=\small]
Nå kan vi snakke om ligning \ref{eq:costfunction} i teksten ...
\end{Verbatim}
...
Gir nummerete ligninger. Må inkludere pakken \texttt{amsmath}.
\end{frame}
...
\begin{frame}{Studerer ikke mer?}
Hva i all verden skal jeg med \LaTeX{} etter studiene?

\vspace{20pt}
Presentasjoner (\texttt{beamer}), papers, bøker, notater m.m.
